...
def send_error_email(exc, context, error_type):
    ...
    try:
        EXCEPTION_MAIL_RECIPIENTS = eval(config('EXCEPTION_MAIL_RECIPIENTS'))
    except:
        EXCEPTION_MAIL_RECIPIENTS = []

    if EXCEPTION_MAIL_RECIPIENTS:
        print(EXCEPTION_MAIL_RECIPIENTS)
        print(type(EXCEPTION_MAIL_RECIPIENTS))
        send_mail(subject, body_msg, config('DEFAULT_FROM_EMAIL'), EXCEPTION_MAIL_RECIPIENTS)